    ...
    return (
        <section className="max-w-[1120px] mx-auto px-5 py-20 scroll-mt-[15px]" id="proyectos">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Proyecto 1 */}
                <div className="bg-card rounded-xl overflow-hidden border border-[rgba(143,97,183,0.112)] shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-transform duration-300 hover:-translate-y-2 flex flex-col">

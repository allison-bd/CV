const Hero = () => {
    return (
        <section className="max-w-[1120px] mx-auto px-5 flex flex-col md:flex-row-reverse items-center justify-center gap-8 md:gap-16 text-center md:text-left min-h-[calc(100vh-80px)] pt-16 md:pt-0 scroll-mt-[72px]" id="inicio" style={{ opacity: 1 }}>
            <div className="flex flex-col items-center gap-6">
                <div className="w-52 h-52 md:w-80 md:h-80 rounded-2xl overflow-hidden shrink-0 photo-frame">
            ...
            <div className="flex-1 mb-11">
                <h1 className="font-display text-[32px] md:text-[64px] font-bold text-accent mb-2 md:tracking-tight leading-[1.1]">Allison Barra Díaz</h1>
                <h2 className="font-display text-xl md:text-2xl font-medium text-texto-sec mb-6">Desarrolladora Frontend · JavaScript</h2>
                <div className="glass-card py-5 px-6 rounded-2xl md:-mx-6">
                    <p className="font-body text-base md:text-lg leading-relaxed text-texto-sec md:mx-0 text-justify">
